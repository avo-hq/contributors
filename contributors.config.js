module.exports = {
  ...
  goodFirstIssuesLink: 'https://avohq.io/good-first-issues',
  roadmapLink: 'https://avohq.io/roadmap',
  ...
  filterOut: ['adrianthedev', 'mihaimdm22', 'Paul-Bob', 'gabirelgiroe1', 'binarygit'],
};
